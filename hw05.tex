...
\begin{center}\bf
Homework 5. Due by 5pm on Thursday 9/30.

Data and the reproducibility of research results
\end{center}
Read pages 8--11 of {\em On Being a Scientist} and \url{https://en.wikipedia.org/wiki/Data_sharing}. Write brief answers to the following questions, by editing the tex file available at \url{https://github.com/ionides/810f21}, and submit the resulting pdf file via Canvas.

\begin{enumerate}

\item What are the roles of `data' and `reproducibility' in the scientific method? (Optionally, you can read more about the scientific method at \url{https://en.wikipedia.org/wiki/Scientific_method}).
  
YOUR ANSWER HERE

\item Do the National Institutes of Health (NIH) and National Science Foundation (NSF) require data sharing for research that they fund? To what extent do you suspect their rules on data sharing are enforced?
